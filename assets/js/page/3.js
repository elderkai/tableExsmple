$('document').ready(function(){
            ...
            manageTypeBo.list.forEach(function(subtotalBo,s){
                if(s == 0){
                    ...
                    <tr class="" style='background: rgba(48, 189, 247, .1)'>
                        <td rowspan="${manageTypeBo.rowSpan}" style='background: #fff'>${manageTypeBo.manageType}</td>
                        <td>${subtotalBo.manageNameRn}</td>
                        <td colspan="2"  style='font-weight: bold;'>${subtotalBo.list[0].manageName}小计</td>
    ...
    instance.post(url.queryTotalityPerformance).then( ( {status ,data }) =>{
